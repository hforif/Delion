...
//                        Toast.makeText(Menu_Main.this, resultgroup.get(c), Toast.LENGTH_SHORT).show();
                    ...
                    //DB 데이터 가게-전화번호,이름,영업시간 String t1,t3,t4에 넣기
                    JSONObject json1 = jsonArray.getJSONObject(0);

//                        String t = json.getString("id");
                    String t1 = json1.getString("phone");
//                        String t2 = json.getString("img");
                    String t3 = json1.getString("name");
                    String t4 = json1.getString("opentime");
...
//                        v.setText(t3);
                    ...
                    pnumber.setText(t1);
                    //DB 데이터 음식세부 메뉴종류,메뉴,가격 String t6,t7,t8
